...
issue](https://github.com/cisagov/ansible-role-chrony-aws/issues) in
...
request](https://github.com/cisagov/ansible-role-chrony-aws/pulls), you
...
```console
cd ansible-role-chrony-aws
pyenv virtualenv <python_version_to_use> ansible-role-chrony-aws
pyenv local ansible-role-chrony-aws
